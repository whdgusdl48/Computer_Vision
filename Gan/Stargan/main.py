...
def parse_args():
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='/home/ubuntu/bjh/Gan/stargan-v2-tensorflow/checkpoint/StarGAN_v2_celebA-HQ_gender_gan-gp/',
                        help='Directory name to save the checkpoints')
    parser.add_argument('--result_dir', type=str, default='/home/ubuntu/bjh/Gan/stargan-v2-tensorflow/results/StarGAN_v2_celebA-HQ_gender_gan-gp/',
                        help='Directory name to save the generated images')
    parser.add_argument('--log_dir', type=str, default='/home/ubuntu/bjh/Gan/stargan-v2-tensorflow/logs/StarGAN_v2_celebA-HQ_gender_gan-gp/',
                        help='Directory name to save training logs')
    parser.add_argument('--sample_dir', type=str, default='/home/ubuntu/bjh/Gan/stargan-v2-tensorflow/results/StarGAN_v2_celebA-HQ_gender_gan-gp/',
