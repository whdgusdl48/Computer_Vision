...
class StarGAN_v2():
    def __init__(self, args):
        ...
        dataset_path = '/home/ubuntu/bjh/Gan/stargan-v2-tensorflow/dataset'
    ...
    def build_model(self):
        if self.phase == 'train':
            ...
            self.generator_ema = copy(self.generator)
            self.mapping_network_ema = copy(self.mapping_network)
            self.style_encoder_ema = copy(self.style_encoder)
