...
from tensorflow.keras.layers import Input,ZeroPadding2D, Flatten, Dense,LeakyReLU,Conv2D,Reshape,Conv2DTranspose,Lambda,BatchNormalization,Dropout,ReLU,Concatenate,UpSampling2D,Add,Activation
...
class DiscoGAN():
    def __init__(self):
        ...
        self.data_loader = DataLoader(dataset_name=self.dataset_name,
                                      img_resize=(self.img_rows, self.img_cols))
    ...
    def sample_images(self, epoch, batch_i):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("/home/ubuntu/bjh/Gan/DISCOGAN/images/%s/%d_%d.png" % (self.dataset_name, epoch, batch_i))
        plt.close()
